...
app.post('/api/group/:groupAdmin', groupController.create);
app.get('/api/groups', groupController.allGroups);
app.post('/api/group/:messageId/message/:sender', messageController.create);
app.get('/api/group/:messageId/messages', messageController.findGroupMessages);
...
app.post('/api/group/:groupId/user/:memberId', groupMemberController.addGroupMember);
